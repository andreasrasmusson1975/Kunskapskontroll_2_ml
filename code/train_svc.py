...
2. Train Model - Trains the SVC model on the training set (fit()).
...
5. Refit for test evaluation (refit for test_set)
6. Evaluate once more on the test set 
